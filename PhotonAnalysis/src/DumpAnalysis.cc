				 ...
				 BaseGenLevelSmearer *genSys, BaseSmearer *phoSys, BaseDiPhotonSmearer * diPhoSys)
{
    ...
    tree_.pho2hoe = (float) l.pho_hoe[diphoton_index.second];
    //Nikolas variables = ;
	...
	tree_.pho2pfiso_cleancharged04 = (float)l.pho_pfiso_cleancharged04[diphoton_index.second] ;
	    ...
	    l.FillTreeContainer();
        //copy 2 in 1 and fill again --- needed for plain tree for training
	    tree_.pho1pt        = tree_.pho2pt;
	    tree_.pho1energy        = tree_.pho2energy;
	    tree_.pho1Eta        = tree_.pho2Eta;
	    tree_.pho1Phi        = tree_.pho2Phi;
	    tree_.pho1scEta        = tree_.pho2scEta;
	    tree_.pho1r9        = tree_.pho2r9;
	    tree_.pho1idMva        = tree_.pho2idMva;
	    tree_.pho1sE        = tree_.pho2sE;
	    tree_.pho1sEsmear        = tree_.pho2sEsmear;
	    tree_.pho1ESEffSigmaRR        = tree_.pho2ESEffSigmaRR;
	    tree_.pho1Matched        = tree_.pho2Matched;
	    tree_.pho1CiC        = tree_.pho2CiC;
	    tree_.pho1sieie        = tree_.pho2sieie;
	    tree_.pho1scetawidth        = tree_.pho2scetawidth;
	    tree_.pho1scphiwidth        = tree_.pho2scphiwidth;
	    tree_.pho1sieip        = tree_.pho2sieip;
	    tree_.pho1s4ratio        = tree_.pho2s4ratio;
	    tree_.pho1pfphotoniso03        = tree_.pho2pfphotoniso03;
	    tree_.pho1pfchargedisogood03        = tree_.pho2pfchargedisogood03;
	    tree_.pho1pfchargedisobad03        = tree_.pho2pfchargedisobad03;
	    tree_.pho1sceta        = tree_.pho2sceta;
	    tree_.pho1hoe        = tree_.pho2hoe;
	    tree_.pho1r9_Ethresh        = tree_.pho2r9_Ethresh;
	    tree_.pho1sieie_Ethresh        = tree_.pho2sieie_Ethresh;
	    tree_.pho1r9_chi2Thresh        = tree_.pho2r9_chi2Thresh;
	    tree_.pho1pfiso_cleanphoton03        = tree_.pho2pfiso_cleanphoton03;
	    tree_.pho1pfiso_cleanneutral03        = tree_.pho2pfiso_cleanneutral03;
	    tree_.pho1pfiso_cleancharged03        = tree_.pho2pfiso_cleancharged03;
	    tree_.pho1pfiso_cleanphoton04        = tree_.pho2pfiso_cleanphoton04;
	    tree_.pho1pfiso_cleanneutral04        = tree_.pho2pfiso_cleanneutral04;
	    tree_.pho1pfiso_cleancharged04        = tree_.pho2pfiso_cleancharged04;
	    tree_.pho1pt        = tree_.pho2pt;
	    tree_.pho1pt        = tree_.pho2pt;
	    l.FillTreeContainer();
        //DONE
