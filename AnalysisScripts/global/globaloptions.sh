...
#amarini
#VARS="pToMscaled dPhi dRapidityHiggsJet dEtajj dEtajjExtended dRapidityHiggsJetExtended Zepp ZeppExtended"
#VARS="pToMscaled dPhi dRapidityHiggsJet dEtajjExtended ZeppExtended"

#swagata
#VARS="$VARS Ygg MjjExtended dPhijjExtended dPhiggjjExtended"
